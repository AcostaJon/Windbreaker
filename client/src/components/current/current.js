...
export default function Current(params) {
    ...
    return(
        <>
            <div className={styles.current} id="current">
                {/* data */}
                <div className={styles.currentSideA}>
                ...
                <div id="currentSideB">
                    ...
                    {contextValue.isDay ? <svg className={styles.currentWeatherImg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#FFD43B" d="M210.2 53.9C217.6 50.8 226 51.7 232.7 
                    ...
                    </svg> : <svg className={styles.currentWeatherImg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#fb8b35" d="M320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576C388.8 576 451.3 548.8 497.3 504.6C504.6 497.6 506.7 486.7 502.6 477.5C498.5 468.3 488.9 462.6 478.8 463.4C473.9 463.8 469 464 464 464C362.4 464 280 381.6 280 280C280 207.9 321.5 145.4 382.1 115.2C391.2 110.7 396.4 100.9 395.2 90.8C394 80.7 386.6 72.5 376.7 70.3C358.4 66.2 339.4 64 320 64z"/></svg> }
                </div>
            </div>
        </>
    )
