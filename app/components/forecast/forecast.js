                ...
                <div className="row container-fluid text-white px-3 py-3 mb-2 mt-md-4 justify-content-evenly text-center rounded shadow-lg fontSize12Lg" id="Forecast">
                    ...
                    <div className="row p-0 justify-content-between mt-3 ">
                        ...
                        <div className="col-3  d-flex flex-column justify-content-evenly align-items-center px-1 pt-md-1 bg-primary rounded">
                            <p className="my-2 my-md-0 fontSize24Lg">{formatDate(props.forecast.day1Forecast.date)}</p>
                            ...
                            <p className="my-2 my-md-0 fontSize24Lg">{day1.condition.text}</p>
                        </div>
                        {/* 2st day */}
                        <div className="col-3 d-flex flex-column justify-content-evenly align-items-center px-1 pt-md-1  bg-primary rounded">
                            <p className="my-2 my-md-0 fontSize24Lg">{formatDate(props.forecast.day2Forecast.date)}</p>
                            ...
                            <img className="my-1 my-md-1 iconForecastLg"  src={day2.condition.icon}  /> 
                             <p className="my-2 my-md-0  fontSize24Lg">{day2.condition.text}</p>
                        </div>
                        {/* 3st day */}
                        <div className="col-3  d-flex flex-column justify-content-evenly align-items-center px-1 pt-md-1  bg-primary rounded">
                            <p className="my-2 my-md-0  fontSize24Lg">{formatDate(props.forecast.day3Forecast.date)}</p>
                            ...
                            <p className="my-2 my-md-0  fontSize24Lg">{day3.condition.text}</p>
                        </div>
                    </div>
                </div>
            </>
